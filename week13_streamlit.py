...
image = Image.open ('/Users/bradmontesino/Desktop/Montefiore.jpg')

st.image (image, caption= 'Montefiore Hospital', use_column_width=True)
...
from PIL import Image 
image = Image.open ('/Users/bradmontesino/Desktop/Drupal-WEB_SIUH_Heart_HeartTowerExterior.jpg')

st.image (image, caption= 'Staten Island University Hospital', use_column_width=True)
